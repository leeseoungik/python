...
#NFC는 완성형으로 정규화
unicodedata.normalize('NFC', '한글')   #정준 분해한 뒤에 다시 정준 결합
unicodedata.normalize('NFKC', '한글')  #호환 분해한 뒤에 다시 정준 결합

#NFD는 조합형 정규화
unicodedata.normalize('NFD', '한글')     #정준 분해
unicodedata.normalize('NFKD', '한글')    #호환 분해
